...
document.write(`<h1>${string_1} ${string_2} ${string_3} ${string_4} ${num_1} ${num_2} ${num_3} ${num_4} ${float_1} ${float_2} ${num_5} ${bool} ${boolean}</h1>`)
console.log(`${string_1} ${string_2} ${string_3} ${string_4} ${num_1} ${num_2} ${num_3} ${num_4} ${float_1} ${float_2} ${num_5} ${bool} ${boolean}`);
alert(`${string_1} ${string_2} ${string_3} ${string_4} ${num_1} ${num_2} ${num_3} ${num_4} ${float_1} ${float_2} ${num_5} ${bool} ${boolean}`);
...
document.write(`<h2>${string_1} ${string_2} ${string_3} ${string_4} ${num_1} ${num_2} ${num_3} ${num_4} ${float_1} ${float_2} ${num_5} ${bool} ${boolean}</h2>`)
console.log(`${string_1} ${string_2} ${string_3} ${string_4} ${num_1} ${num_2} ${num_3} ${num_4} ${float_1} ${float_2} ${num_5} ${bool} ${boolean}`);
alert(`${string_1} ${string_2} ${string_3} ${string_4} ${num_1} ${num_2} ${num_3} ${num_4} ${float_1} ${float_2} ${num_5} ${bool} ${boolean}`);
...
document.write('<h3>' + INSTAGRAM + TELEGRAM + FACEBOOK + PI + TIME + MIN + '</h3>');
console.log(INSTAGRAM + TELEGRAM + FACEBOOK + PI + TIME + MIN);
alert(INSTAGRAM + TELEGRAM + FACEBOOK + PI + TIME + MIN);
